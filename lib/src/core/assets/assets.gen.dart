...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/bupati.webp
  AssetGenImage get bupati => const AssetGenImage('assets/images/bupati.webp');
...
class $AssetsLogoGen {
  ...
  /// File path: assets/logo/fastkes.webp
  AssetGenImage get fastkes => const AssetGenImage('assets/logo/fastkes.webp');
...
class $AssetsImagesNewsGen {
  ...
  /// File path: assets/images/news/Stuba_2_Small.webp
  AssetGenImage get stuba2Small =>
      const AssetGenImage('assets/images/news/Stuba_2_Small.webp');

  /// File path: assets/images/news/akreditasi2022_Small.webp
  AssetGenImage get akreditasi2022Small =>
      const AssetGenImage('assets/images/news/akreditasi2022_Small.webp');

  /// File path: assets/images/news/monevsisruj2.webp
  AssetGenImage get monevsisruj2 =>
      const AssetGenImage('assets/images/news/monevsisruj2.webp');
}
