...
class _FormGelarBelakangField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FormzTextField(
      textEditingController: TextEditingController(text: 'Sp.JP'),
...
class _FormCityField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FormzTextField(
      textEditingController: TextEditingController(text: 'Kabupaten Blitar'),
...
class _FormDistrictField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FormzTextField(
      textEditingController: TextEditingController(text: 'Kec. Srengat'),
...
class _FormVillageField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FormzTextField(
      textEditingController: TextEditingController(text: 'Dandong'),
